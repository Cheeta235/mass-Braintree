...
stopuser = {}
token = '7337962051:AAFpu6OGpFs3Ts5u9GPpvlZgJyqlTGHrXxw'
			...
			with open("combo.txt", 'r') as file:
				...
				for cc in lino:
					if stopuser[f'{id}']['status'] == 'stop':
						...
						return
					try:
						binn = requests.get(f'https://bins.antipublic.cc/bins/{cc[:6]}')
...
Card: XXXXXXXXXXXXXXXX|MM|YYYY|CVV</b>''',parse_mode="HTML")
	...
	try:
		...
		last='Error'
	try: binn = requests.get(f'https://bins.antipublic.cc/bins/{bin[:6]}')
	except: pass
	try:
		brand = data['brand']
	except:
